...
-- Mode: STRICT_PRIORITY_WITH_DELTA
...
local PARAMS = {
  PRIORITY_WEIGHT = 1.8,  -- Weight for priority_factor influence
  RATING_WEIGHT = 1,    -- Weight for rating influence
  FLOW_WEIGHT = 1,      -- Weight for flow influence
}
