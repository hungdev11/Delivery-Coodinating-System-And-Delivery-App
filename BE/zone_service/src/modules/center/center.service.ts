...
export class CenterService {
	 ...
	 */
	public static async getAllCenters(
		request: CenterPagingRequest
	): Promise<PagedData<CenterDto>> {
		try {
			const where: any = {};
	 ...
	 * Get center by code
	 */
	public static async getCenterByCode(
		code: string
	 ...
	 * Create a new center
	 */
	public static async createCenter(
	...
	public static async updateCenter(
		...
		try {
			...
			if (data.polygon !== undefined)
				updateData.polygon = data.polygon ?? null;
