...
CREATE DATABASE IF NOT EXISTS ds_zone_service;
CREATE DATABASE IF NOT EXISTS ds_parcel_service;
CREATE DATABASE IF NOT EXISTS ds_session_service;
CREATE DATABASE IF NOT EXISTS ds_communication_service;
...
-- GRANT ALL PRIVILEGES ON ds_zone_service.* TO 'dss_user'@'%';
-- GRANT ALL PRIVILEGES ON ds_parcel_service.* TO 'dss_user'@'%';
-- GRANT ALL PRIVILEGES ON ds_session_service.* TO 'dss_user'@'%';
-- GRANT ALL PRIVILEGES ON ds_communication_service.* TO 'dss_user'@'%';
