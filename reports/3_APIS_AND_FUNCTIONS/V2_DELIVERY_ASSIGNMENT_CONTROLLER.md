# API Documentation: Delivery Assignment Controller (v2)
...
|--------|------|-----------------------------------------------|-------------------|--------------------|-----------------------------------------|
| `POST` | `/`  | List delivery assignments based on a query. | `listAssignments` | Authenticated User | `session-service` (`/api/v2/assignments`) |
