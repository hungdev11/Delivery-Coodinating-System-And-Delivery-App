<template>
  <Transition name="slide">
    ...
    >
      <div class="flex items-start gap-3">
        ...
        <UButton color="gray" variant="ghost" size="xs" icon="i-lucide-x" @click="dismissPrompt" />
      </div>

      <template #footer>
        <div class="flex gap-2 justify-end">
          <UButton color="gray" variant="ghost" size="sm" @click="dismissPrompt">
            Không, cảm ơn
          </UButton>
  ...
  <Transition name="slide">
    <UCard
      ...
      class="fixed top-4 left-4 right-4 z-50 max-w-sm shadow-lg"
      :ui="{
        background: 'bg-white dark:bg-gray-900',
        ring: 'ring-1 ring-gray-200 dark:ring-gray-700',
      }"
