 ...
 * Parcel Delete Modal
 *
 * Confirmation modal for deleting parcel(s)
...
const message = computed(() => {
  if (props.count && props.count > 1) {
    return `Are you sure you want to delete ${props.count} parcels? This action cannot be undone.`
  }
  return `Are you sure you want to delete parcel ${props.parcelCode}? This action cannot be undone.`
})
